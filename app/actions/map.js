...
export const setTimes = createAction('set times')
export const setTimesFromUrl = createAction('set times from url')
export const enableHotOverlay = createAction('enable hot overlay')
export const disableHotOverlay = createAction('disable hot overlay')
export const setEmbedFromUrl = createAction('set embed from url')
export const setThemeFromUrl = createAction('set theme from url')
