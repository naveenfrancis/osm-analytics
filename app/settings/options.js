...
export const compareTimes = [
  { id: '2007', timestamp: new Date('2007-01-01'), except: ['waterways', 'pois'] },
  { id: '2008', timestamp: new Date('2008-01-01'), except: ['waterways', 'pois'] },
  { id: '2009', timestamp: new Date('2009-01-01'), except: ['waterways', 'pois'] },
  { id: '2010', timestamp: new Date('2010-01-01'), except: ['waterways', 'pois'] },
  { id: '2011', timestamp: new Date('2011-01-01'), except: ['waterways', 'pois'] },
  { id: '2012', timestamp: new Date('2012-01-01'), except: ['waterways', 'pois'] },
